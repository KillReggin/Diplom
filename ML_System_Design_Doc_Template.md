...
Дополнительно может использоваться сравнение
с историческими данными урожайности участка
Данный способ позволяет оценить,
насколько прогноз системы соответствует
типичным значениям для данного виноградника.

Однако данный подход носит вспомогательный характер,
так как урожайность может существенно варьироваться
в зависимости от внешних факторов.
Использование исторических данных зависит
от стабильности урожайности участка.

- при высокой вариативности урожая
  исторические данные используются только
  для выявления аномалий

- при стабильной урожайности
  исторические данные могут использоваться
  как дополнительный ориентир
  для оценки адекватности прогноза
### Дизайн пилота
...
Пилот считается успешным, если система позволяет
получать достаточно точную и полезную оценку урожайности
для принятия управленческих решений.

### Критерии успешности

1. **Точность оценки урожайности**

- ошибка прогноза не превышает **10–20%** 
  на уровне участка виноградника
Ошибка прогноза складывается из :
- ошибки детекции (ложные и пропущенные объекты)
- ошибки геометрической аппроксимации
- ошибки оценки массы

2. **Полнота обнаружения гроздей**

- система обнаруживает большую часть гроздей
- отсутствуют систематические пропуски объектов

3. **Отсутствие критических переоценок**

- Ложные детекции допустимы,
однако их вклад в итоговую оценку урожайности
не должен превышать 5–10%.
- Система не должна систематически завышать урожайность.
Допускается:
- небольшое занижение

Критическим считается систематическое завышение прогноза.
Это достигается за счёт:

- фильтрации объектов с низкой уверенностью
- исключения аномально малых объектов
- агрегации результатов на уровне участка

4. **Стабильность результатов**

- результаты системы воспроизводимы
- отсутствуют сильные колебания при обработке похожих данных

5. **Практическая применимость**

- результаты представлены в понятном виде (отчёт, графики)
- данные могут быть использованы для:
  - планирования сбора урожая
  - оценки объёма производства
  - анализа состояния виноградника

### Возможные дальнейшие шаги

В случае успешного пилота:

- масштабирование на весь виноградник
