...
- время получения оценки урожайности:
  - не более 1–2 дней
  - (по сравнению с текущими 2–3 неделями)

Сокращение времени оценки позволяет:

- заранее планировать сбор урожая  
- оптимизировать распределение трудовых ресурсов  
- снижать простои техники  
- оперативно пересчитывать прогноз при изменении условий  

Таким образом, скорость получения оценки
влияет не только на удобство,
но и на экономическую эффективность
бизнес-процессов.

#### Повышение точности

- ошибка прогноза урожайности:
  - не более ±10–20%
  - (по сравнению с текущей погрешностью до 25%)

---

#### Снижение неопределенности

- отсутствие систематического завышения прогноза  
- стабильность результатов на схожих участках  
...
- снижение трудозатрат на проведение оценки  
- уменьшение зависимости от экспертной оценки  
- повышение эффективности принятия решений  

---
### Пример 
На примере винодельни 4700га с предполагаемым объемом урожая 30тыс тонн
Текущая ошибка ручного прогноза: 15–25% (в среднем 20%).

Ошибка ML-метода: до 10%.

Снижение потерь от неточного планирования: с 3% стоимости урожая до 1,5% → экономия ≈18 млн руб./год.

Сокращение трудозатрат: вместо 50 часов полевой работы агронома — 10 часов на облёт и обработку → дополнительная экономия.

Общая ежегодная экономия: ≈18 млн руб.

Разовые затраты на внедрение: ~500 тыс. руб. (разработка модели, оборудование, обучение).

Окупаемость: менее 1 месяца.
### Итог

Пилот считается успешным, если система позволяет
быстрее и точнее оценивать урожайность по сравнению
с ручным способом и может быть использована
