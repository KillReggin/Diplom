...
- визуальная проверка корректности детекции
- анализ распределения гроздей
- проверка корректности отчётности
...
- система не даёт значительного завышения урожайности
- ложные детекции не влияют существенно на итоговый результат
...
Первоначальная оценка проводится на основе baseline-решения:
...
- отсутствие сложных ансамблей моделей  
